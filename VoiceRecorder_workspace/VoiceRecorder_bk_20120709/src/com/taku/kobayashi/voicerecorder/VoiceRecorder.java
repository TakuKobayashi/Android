...
public class VoiceRecorder{
	...
	public boolean startRecord(int AudioSource){
		if(m_bRecording == false){
			...
			int nMaxDuration = setting.getInt(m_Context.getResources().getString(R.string.SettingMaxDurationKey), Config.DEFAULT_MAXDURATION);
			int nTime = setting.getInt(m_Context.getResources().getString(R.string.SettingTimeKey), 0);
			nMaxDuration = getMaxDuration(nMaxDuration, nTime);
			//Timer == -1 で無限大
